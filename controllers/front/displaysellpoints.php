...
class MaplocaliceDisplaysellpointsModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        $CITY = $data_module->uniqueCity(getCityShopSellPoint());
        $this->context->smarty->assign(array(
            ...
            'ADDR' => $addss,
            'CITYS' => $CITY,
            'my_module_link' => $this->context->link->getModuleLink('maplocalice', 'ajaxsellpoints'),
            'directory_module' => _PS_MODULE_DIR_
        ));
        
        $this->setTemplate('module:maplocalice/views/templates/front/displaysellpoints.tpl');
    }
}
