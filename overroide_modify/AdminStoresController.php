...
class AdminStoresControllerCore extends AdminController
{
    public function __construct()
    {
        ...
        $this->fields_list = array(
            ...
            /**Line ADD */
            'type_store' => array('title' => $this->trans('Type Store', array(), 'Admin.Global'), 'filter_key' => 'a!type_store'),
            /**END */
    ...
    public function renderForm()
    {
                ...
                array(
                    ...
                    'values' => array(
                        array(
                            'id' => 'sell_point',
                            'value' => 0,
                            'label' => $this->trans('Sell Point', array(), 'Admin.Global')
                        ),
                        array(
                            'id' => 'technical_server',
                            'value' => 1,
                            'label' => $this->trans('Technical Server', array(), 'Admin.Global')
                        )
                    ),
                    'hint' => array(
                        $this->trans('select your type of store, between points sell or technical server', array(), 'Admin.Shopparameters.Feature')
                    )
                ),
                array(
                    'type' => 'text',
        ...
        /**Line ADD */
        $type_store = '';
        if($this->getFieldValue($obj, 'type_store')=='Sell Point'):
           $type_store = 0; 
        elseif($this->getFieldValue($obj, 'type_store')=='Technical Server'):
           $type_store = 1; 
        endif;
        /** END */
        $this->fields_value = array(
            /**Line ADD */
            'type_store' => $type_store ? $type_store : '',
            /** END */
    ...
    public function postProcess()
    {
        if (isset($_POST['submitAdd'.$this->table])) {
            ...
            /**Line ADD */
            if(!$_POST['type_store']):
               $_POST['type_store'] = 'Sell Point'; 
            elseif($_POST['type_store'] ==1):
               $_POST['type_store'] = 'Technical Server'; 
            endif;
            /**END */
    ...
    protected function _getDefaultFieldsContent()
    {
        ...
        $formFields = array(
            /**Line ADD */
            'PS_SHOP_TYPE_STORE' => array(
                'title' => $this->trans('Type Store', array(), 'Admin.Shopparameters.Feature'),
                'hint' => $this->trans('Displayed type stores.', array(), 'Admin.Shopparameters.Feature'),
