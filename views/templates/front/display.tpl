...
<div id="box-map" class="container p-0">
    ...
    <div class="row">
        <div class="col-xs-12 module-title">
            <h4 class="title_block">{l s='Technical service and guarantee' mod='maplocalice'}</h4>
        </div><!-- /.col-xs-12 -->
    </div><!-- /.row -->
    <div class="row info-map">
        <div class="col-sm-4">
            <aside>
			    <div class="parrafo">
					<h4><span>{$TITLE_LEFT_TS}</span></h4>
					<div>{$CONTENT_LEFT_TS|unescape: "html" nofilter}</div>
				</div>                
        ...
        <div class="col-sm-8">
            ...
            <div class="parrafo2">
					<div class="title-p2-box">
						<span class="title-p2">{$TITLE_RIGHT_TS}</span>
					</div>
					<div>{$CONTENT_RIGHT_TS|unescape: "html" nofilter}</div>
				</div>
        </div><!-- /.col-sm-8-->
    </div><!-- /.row -->
</div><!-- /.container -->
